...
const productosPerfumeria = document.getElementById('perfumeriaList')
...
function cargarEventos() {
	...
	productosPerfumeria.addEventListener("click", (e) => {
...
async function fetchProductos() {
    ...
    const data = product.perfumeria
    data.forEach(producto => {
        productosPerfumeria.innerHTML = "";
    ...
    productosPerfumeria.appendChild(fragment);
}